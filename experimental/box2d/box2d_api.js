exports.Box2D = (function() {
    var ext = {};
    ext.makeCall = function(cmd, args) {
        var msg = {
            "command": cmd
        };
        ...
        var result_txt = extension.internal.sendSyncMessage(msg_txt);
    ...
    // ***************************************************************************
        ...
        B2Fixture.prototype.SetSensor = function(isSensor) { 
            ext.makeCall( "setSensor" , this.m_body.m_world.m_worldID , this.m_fixtureID , this.m_isSensor) ;
            this.m_isSensor = isSensor ;
        };
    
        B2Fixture.prototype.IsSensor = function() { return this.m_isSensor ; } ;
    
        B2Fixture.prototype.SetDensity     = function( density     ) { ext.makeCall( "setDensity"     , this.m_body.m_world.m_worldID , this.m_fixtureID , density     ) ; this.m_density = density         ; } ;
        B2Fixture.prototype.SetFriction    = function( friction    ) { ext.makeCall( "setFriction"    , this.m_body.m_world.m_worldID , this.m_fixtureID , friction    ) ; this.m_friction = friction       ; } ;
        B2Fixture.prototype.SetRestitution = function( restitution ) { ext.makeCall( "setRestitution" , this.m_body.m_world.m_worldID , this.m_fixtureID , restitution ) ; this.m_restitution = restitution ; } ;
        ...
        var B2Body = function (bd, world) {
            ...
            this.m_bodyID = ext.makeCall( "createBody" , world.m_worldID , bd ) ;      
        ...
        B2Body.prototype.CreateFixture = function (def) {
            ...
            var fixtureID = ext.makeCall( "createFixture" , this.m_world.m_worldID , this.m_bodyID , def ) ; 
        ...
        B2Body.prototype.DestroyFixture = function(){
            // DO NOTHING!
            console.log('DestroyFixture not supported yet in CocoonJS Box2D binding');
        };
       
        B2Body.prototype.SetPositionAndAngle = function (position, angle) {
            ext.makeCall( "setBodyTransform" , this.m_world.m_worldID , this.m_bodyID , position.x , position.y , angle ) ; 
        ...
        B2Body.prototype.GetLinearVelocity  = function(){
            var v = ext.makeCall( "getLinearVelocity" , this.m_world.m_worldID , this.m_bodyID ) ; 
            return new B2Vec2(v[0],v[1]);
        };
    
        B2Body.prototype.GetWorldCenter = function(){
            var p = ext.makeCall( "getWorldCenter"  , this.m_world.m_worldID , this.m_bodyID ) ; 
            return new B2Vec2(p[0],p[1]);
        };
    
        B2Body.prototype.GetLocalCenter = function(){
            var p = ext.makeCall( "getLocalCenter"  , this.m_world.m_worldID , this.m_bodyID ) ; 
            return new B2Vec2(p[0],p[1]);
        };
    
     
        B2Body.prototype.ApplyImpulse = function( impulse , point , wake ) { 
            ext.makeCall( "applyImpulse" , this.m_world.m_worldID , this.m_bodyID , impulse.x , impulse.y , point.x , point.y , wake ) ; 
        };
    
        B2Body.prototype.IsAwake            = function( )       { return ext.makeCall( "isAwake"            , this.m_world.m_worldID , this.m_bodyID ) ; } ;
        B2Body.prototype.GetAngularVelocity = function( )       { return ext.makeCall( "getAngularVelocity" , this.m_world.m_worldID , this.m_bodyID ) ; } ;
        B2Body.prototype.SetAwake           = function( state )        { ext.makeCall( "setAwake"           , this.m_world.m_worldID , this.m_bodyID , state   ) ; } ;
      
        B2Body.prototype.SetLinearVelocity  = function( vel   )        { ext.makeCall( "setLinearVelocity"  , this.m_world.m_worldID , this.m_bodyID , vel.x   , vel.y ) ; } ;
        B2Body.prototype.ApplyForceToCenter = function( force , wake ) { ext.makeCall( "applyForceToCenter" , this.m_world.m_worldID , this.m_bodyID , force.x , force.y , wake ) ; } ;
        B2Body.prototype.SetLinearDamping   = function( damp  )        { ext.makeCall( "setLinearDamping"   , this.m_world.m_worldID , this.m_bodyID , damp    ) ; } ;
        B2Body.prototype.SetAngularVelocity = function( angvel)        { ext.makeCall( "setAngularVelocity" , this.m_world.m_worldID , this.m_bodyID , angvel  ) ; } ;
        B2Body.prototype.SetActive          = function( state )        { ext.makeCall( "setActive"          , this.m_world.m_worldID , this.m_bodyID , state   ) ; this.m_active = state ; } ;
        ...
        B2Body.prototype.GetContactList = function () {
            var contacts = ext.makeCall( "getObjectContacts" , this.m_world.m_worldID , this.m_bodyID ) ; 
            var result = [];
        ...
        var B2World = function (gravity, doSleep) {
            ...
            this.m_worldID = ext.makeCall( "createWorld" , gravity.x , gravity.y , doSleep );
        };
        ...
        B2World.prototype.DestroyBody = function (b) {
            ext.makeCall( "deleteBody" , this.m_worldID , b.m_bodyID ) ; 
        ...
        B2World.prototype.CreateJoint = function (def) {
            ...
            ext.makeCall( "createDistanceJoint" , this.m_worldID , def ) ;
        ...
        B2World.prototype.SetContinuousPhysics = function (continuous) { ext.makeCall( "setContinuous" , this.m_worldID, continuous ) ; } ;
        B2World.prototype.SetGravity           = function (gravity) { ext.makeCall( "setGravity" , this.m_worldID, gravity.x , gravity.y ) ; } ;
       
        B2World.prototype.Step = function (dt, velocityIterations, positionIterations) {
            var i;
            var transforms = ext.makeCall( "step" , this.m_worldID, dt , velocityIterations , positionIterations );
            ...
            if( this.m_contactListener !== null ){
                var contacts = ext.makeCall( "getLastContacts" , this.m_worldID );
                count = contacts[0];
        ...
        B2World.prototype.ClearForces = function () {
            ext.makeCall( "clearForces" , this.m_worldID );
        };
