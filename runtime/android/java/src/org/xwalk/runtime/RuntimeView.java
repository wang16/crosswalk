...
public class RuntimeView extends FrameLayout {
    // The actual implementation to hide the internals to API users.
    private RuntimeViewProvider mProvider;

    /**
     * Contructs a RuntimeView with a Context object.
     *
     * @param context a Context used by runtime from web app APK.
     */
    public RuntimeView(Context context) {
        super(context, null);
        mProvider = new RuntimeViewProvider(context, this);
    }
